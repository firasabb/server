...
Route::get('/language/{language}', 'LanguageController@getLanguage')->name('getLanguage')->middleware('cors');

Route::get('/languages', 'LanguageController@getLanguages')->name('getLanguages')->middleware('cors');
